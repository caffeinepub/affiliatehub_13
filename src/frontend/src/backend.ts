...
export class Backend implements backendInterface {
    ...
    async getTotalAffiliatesJoined(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalAffiliatesJoined();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalOffersAvailable(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalOffersAvailable();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalPayoutsMade(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalPayoutsMade();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
